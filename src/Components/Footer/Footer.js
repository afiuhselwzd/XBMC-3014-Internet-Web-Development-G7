...
const Footer = () => {
  ...
  const noNamed = [
    { name: "eConsult.portal@gmail.com", link: "/" },
    { name: "+60377181000", link: "/checkup" },
  ...
  const ourAddress = [
    {
      name: "119, Jalan SS 20/10, Damansara Utama, 47400 Petaling Jaya, Selangor",
    },
  ];
  const oralHealth = [
    { name: "Emergency", link: "/emergency" },
        ...
        <div className="container pt-3">
          <div className="row py-5">
            ...
            <FooterCol key={4} menuTitle="Our Address" menuItems={ourAddress}>
              ...
              <div className="mt-2">
                <h6 className="mb-2"> Open Admin Panel</h6>
                <button
          ...
          <div className="copyRight text-center pb-3 text-secondary">
            <p> &copy; 2021 Developed by Group 7</p>
          </div>
        </div>
      </footer>
      ...
      >
        <form className="px-5 my-3 text-center">
          ...
          <h5 className="text-secondary mb-3">
            Email: doctors.portal@gmail.com
          </h5>
          <h6 className="text-secondary mb-3">Password: AdminDoctor@123</h6>
          <p className="text-center mb-2 mt-3 px-5">
            <small>
              Or you can create a new account or signIn with a account which You
              did not use or provide as an patient appointment email.{" "}
            </small>
          </p>
