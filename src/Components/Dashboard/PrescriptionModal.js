...
const PrescriptionModal = (props) => {
  ...
  const onSubmit = (newPrescript, e) => {
    ...
    const newPrescription = SelectedApForModify.prescription
      ? Array.from(SelectedApForModify.prescription)
      : [];
    ...
    const data = {
      id: props.selectAppointment._id,
          ...
          <div>
            <div className="mb-3 mb-4 d-flex justify-content-between">
              <span className="text-primary">
                {props.selectAppointment.patientInfo.name}
              </span>
            ...
            <form
              className="row add-prescription"
              ...
              {props.selectAppointment.prescription && (
                <table className="table table-borderless">
                  {props.selectAppointment.prescription.length &&
                    props.selectAppointment.prescription.map(
                      (prescript, index) => (
                        <tr>
                          <td>{index + 1}.</td>
