        ...
        <div className="row mb-5">
          <div className="col-md-7 align-self-center">
            ...
            <p className="text-secondary my-5" style={{ fontSize: "20px" }}>
              Join Our eConsult Team and Create your Virtual Chamber. Provide
              Medical Consultancy via video call and expand the reach of your
              service. We have a strong network of Bangladeshi registered
              doctors that you can trust.
            </p>
            <Link to="/dashboard">
              <button className="btn btn-primary button-style mb-5">
                Sign Up
              </button>
            </Link>
          </div>
