...
const AppointmentTable = () => {
  ...
  const modalController = (apId) => {
    setModalIsOpen(true);
    const selectedAp = contextAppointmentData.allAppointments.find(
      (ap) => ap.id === apId
    );
    if (selectedAp) {
        ...
        {isBooked ? (
          <div className="text-center  py-5 my-5">
            ...
            <p className="mt-5 px-3">
              Please go to Dashboard and Login with your email which you
              provided into booking appointment to view details.
            </p>
